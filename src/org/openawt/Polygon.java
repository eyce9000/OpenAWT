 ...
 * {@link org.openawt.geom.PathIterator#WIND_EVEN_ODD WIND_EVEN_ODD}
...
public class Polygon implements Shape, java.io.Serializable {
    ...
    public Polygon(int xpoints[], int ypoints[], int npoints) {
        ...
        //TODO MODIFIED TO LOWER API LEVEL TO JAVA 5
        
        this.xpoints = ArrayHelper.copyOf(xpoints, npoints);
        this.ypoints = ArrayHelper.copyOf(ypoints, npoints);
    }
     ...
     * reset.
     * @see         org.openawt.Polygon#invalidate
     * @since 1.4
     */
    public void reset() {
        npoints = 0;
     ...
     * @see         org.openawt.Polygon#getBounds
     * @since 1.4
     */
     ...
     * @see         org.openawt.Polygon#getBounds
     * @see         org.openawt.Polygon#contains
     * @since 1.0
     */
    public void addPoint(int x, int y) {
        if (npoints >= xpoints.length || npoints >= ypoints.length) {
            ...
            xpoints = ArrayHelper.copyOf(xpoints, newLength);
            ypoints = ArrayHelper.copyOf(ypoints, newLength);
